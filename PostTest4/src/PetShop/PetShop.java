...
public class PetShop {
    ...
    private static void TambahBarang(String jenis) {
        clearScreen();
        String nama;
        double harga;
        System.out.print("Nama Barang   : ");
    ...
    private static void TambahMakanan(String jenisHewan) {
    clearScreen();
    String nama;
    double harga;
    System.out.print("Nama Makanan   : ");
    ...
    private static void TambahSuplemen(String jenisHewan) {
    clearScreen();
    String nama;
    double harga;
    System.out.print("Nama Suplemen   : ");
    ...
    private static void TambahAksesoris(String jenisHewan) {
        clearScreen();
        String nama;
        double harga;
        System.out.print("Nama Aksesoris  : ");
