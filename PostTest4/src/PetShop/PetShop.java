...
class MakananHewan extends Barang {
    ...
    @Override
    public String toString() {
        return "Makanan Hewan - Nama: " + namaMakanan + ", Harga: " + getHarga() + ", Jenis Hewan: " + jenisHewan;
    }
}
...
class Suplemen extends Barang {
    ...
    @Override
    public String toString() {
        return "Suplemen - Nama: " + namaSuplemen + ", Harga: " + getHarga() + ", Jenis Hewan: " + jenisHewan;
    }
}
...
class AksesorisHewan extends Barang {
    ...
    public AksesorisHewan(String namaAksesoris, double harga, String jenisHewan, String jenisAksesoris) {
        super(namaAksesoris, harga);
        this.jenisHewan = jenisHewan;
    ...
    @Override
    public String toString() {
        if (jenisAksesoris != null) {
            return "Aksesoris Hewan - Nama: " + getNama() + ", Harga: " + getHarga() + ", Jenis Hewan: " + jenisHewan + ", Jenis Aksesoris: " + jenisAksesoris;
        } else {
